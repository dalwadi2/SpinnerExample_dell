...
public class Listview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //  List<objectfile> donorlist = obj_dbhelper.getName(bloodgroup);
        obj_dbhelper.getName(bloodgroup,district);
        Toast.makeText(Listview.this,"getname listview",Toast.LENGTH_LONG).show();
      ...
      // List<objectfile> contactlist = obj_dbhelper.getName(bloodgroup);
        obj_dbhelper.getName(bloodgroup,district);
        Toast.makeText(Listview.this,"getname listview",Toast.LENGTH_LONG).show();
