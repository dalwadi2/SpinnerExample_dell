        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             // List<objectfile> mStudentList = obj_dbhelper.getData(bloodgroup, state, city, district, area);
              ...
              //Log.d("vidhi", "This is From Activity : " + obj_dbhelper.getName(bloodgroup,district));

                //calling now
              //  List<objectfile> mStudentList = obj_dbhelper.getData(bloodgroup,state,district,city,area);
                //obj_dbhelper.getName(bloodgroup);
                //Toast.makeText(Search_donor.this, obj_dbhelper.getName(bloodgroup,district)  ,Toast.LENGTH_LONG).show();
                List<String> mList = obj_dbhelper.getName(bloodgroup,district);
                Bundle b = new Bundle();
                b.putString("Name",mList.get(0));
                b.putString("Contact",mList.get(1));
                Intent mIntent = new Intent(Search_donor.this,ViewDonar.class);
                mIntent.putExtras(b);
